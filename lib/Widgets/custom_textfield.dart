...
class CustomTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      cursorColor: ColorConstant.redAccent.withOpacity(0.6),
      decoration: InputDecoration(
        ...
        enabled: enable ?? true,
        counterText: "",
        labelStyle: TextStyleConstant.medium14(color: ColorConstant.darkGrey),
        ...
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(
              ...
              color: focuseBorderColor ?? ColorConstant.redAccent),
          borderRadius: borderRadius ?? BorderRadius.circular(10),
        ),
        ...
        focusColor: ColorConstant.redAccent,
        labelText: labelText,
        hintText: hintText,
